            ...
            {equipment && (
              <MapComponent
                locations={[{
                  ...
                  latitude: 34.0522, // Default latitude since equipment doesn't have coordinates
                  longitude: -118.2437, // Default longitude since equipment doesn't have coordinates
                  price: equipment.daily_price,
                  type: equipment.equipment_type, // Use equipment_type from Equipment interface
